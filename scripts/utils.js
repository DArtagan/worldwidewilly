...
function google_analytics() {
  ...
  try {
  var pageTracker = _gat._getTracker("UA-8980572-1");
...
function translator(pattern) {
      window.location="http://www.google.com/translate?u=" + location.href + "&hl=en&ie=UTF8&langpair=" + pattern + "&langpair.x=9&langpair.y=11&langpair="+ pattern;}
//----------------------------------------------------------------------------
